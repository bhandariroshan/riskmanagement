"""
Base settings for IntuitiveWebSolution project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (intuitiveweb/config/settings/base.py - 3 = intuitiveweb/)
APPS_DIR = ROOT_DIR.path('intuitiveweb')
...
ADMINS = [
    ("""Roshan Bhandari""", 'brishi98@gmail.com'),
]
